...
def make_similarity(score=0.0, depth=None, synset1=None, synset2=None, strategy="no-context"):
	return {
		"score": score,
		"distance": depth,
		"synset1": synset1,
...
def build_wup_similarity(lesk=None):
...
def run_evaluations(project_root):
	...
	similarity_full = build_wup_similarity(lesk_full)
	similarity_ablated = build_wup_similarity(lesk_ablated)
	similarity_no_context = build_wup_similarity()
...
def run_wup_pipeline(project_root=None):
